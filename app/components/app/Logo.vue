...
const sizes: Record<NonNullable<Props['size']>, { iconClass: string, textClass: string }> = {
  md: { iconClass: 'size-10 md:size-8', textClass: 'text-md md:text-lg' },
  lg: { iconClass: 'size-10 md:size-14', textClass: 'text-md md:text-2xl' },
}
